      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 mt-16">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
          <div className="p-8">
            ...
            {/* Study Material Link */}
{isAuthenticated && examAccess?.hasAccess && exam.study_mat_url && (
  <div className="mb-5">
    <a
      href={exam.study_mat_url}
      target="_blank"
      rel="noopener noreferrer"
      className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
    >
      <svg
        className="w-5 h-5"
        fill="none"
